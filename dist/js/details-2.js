window.onload = function(){
  ...
  $.ajax({
    ...
    success: function (arr) {
      //水果
      var str1 = ` 价格：<span>  ${arr[1].price}  </span> `;
      var str = `  <button  id="0" class="b3">加购物车</button>    `;
     
      $(".price").find('.p1').html(str1);
      $(".price-3").find('span').html(str);
...
$(".price-3 span").on("click", ".b3", function(){
//取出当前点击加入购物车按钮的id
...
sc_msg();
      ...
      $("#car ul").on("click", ".sc_goodsNum button", function(){
      ...
      function sc_msg(){
        ...
        <img src="http://img09.yiguoimg.com/d/items/2020/200312/9288740085508204_500.jpg" alt="">
        </div>
